...
public class TeamTestSamples {
    ...
    public static Team getTeamSample1() {
        return new Team().id(1L).name("name1").createdBy("createdBy1").modifiedBy("modifiedBy1");
    }

    public static Team getTeamSample2() {
        return new Team().id(2L).name("name2").createdBy("createdBy2").modifiedBy("modifiedBy2");
    }
