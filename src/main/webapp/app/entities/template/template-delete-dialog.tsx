...
import { getEntity, deleteEntity } from './template.reducer';
...
export const TemplateDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/template' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trackerApp.template.delete.question">Are you sure you want to delete Template {templateEntity.id}?</ModalBody>
      <ModalFooter>
