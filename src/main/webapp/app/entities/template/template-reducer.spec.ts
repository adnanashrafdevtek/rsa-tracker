...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './template.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATE actions', async () => {
      const expectedActions = [
        {
