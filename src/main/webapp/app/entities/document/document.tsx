            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('mimeType')}>
                  Mime Type <FontAwesomeIcon icon={getSortIconByFieldName('mimeType')} />
                </th>
            ...
            <tbody>
              {documentList.map((document, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{document.message ? <Link to={`/message/${document.message.id}`}>{document.message.id}</Link> : ''}</td>
                  <td>{document.team ? <Link to={`/team/${document.team.id}`}>{document.team.id}</Link> : ''}</td>
