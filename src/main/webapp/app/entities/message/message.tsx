          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('sendToAllTeamMembers')}>
                  Send To All Team Members <FontAwesomeIcon icon={getSortIconByFieldName('sendToAllTeamMembers')} />
                </th>
                <th className="hand" onClick={sort('dateSent')}>
                  Date Sent <FontAwesomeIcon icon={getSortIconByFieldName('dateSent')} />
                </th>
                <th>
                  To User Id <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  From User Id <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {messageList.map((message, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{message.sendToAllTeamMembers ? 'true' : 'false'}</td>
                  <td>{message.dateSent ? <TextFormat type="date" value={message.dateSent} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{message.toUserId ? message.toUserId.id : ''}</td>
                  <td>{message.fromUserId ? message.fromUserId.id : ''}</td>
                  <td>{message.team ? <Link to={`/team/${message.team.id}`}>{message.team.id}</Link> : ''}</td>
