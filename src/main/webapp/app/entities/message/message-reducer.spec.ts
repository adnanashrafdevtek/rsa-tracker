...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './message.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESSAGE actions', async () => {
      const expectedActions = [
        {
