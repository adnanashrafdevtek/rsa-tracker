...
export const MessageDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/message' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trackerApp.message.delete.question">Are you sure you want to delete Message {messageEntity.id}?</ModalBody>
      <ModalFooter>
