...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATETASK_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATETASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATETASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATETASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATETASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATETASK actions', async () => {
      const expectedActions = [
        {
