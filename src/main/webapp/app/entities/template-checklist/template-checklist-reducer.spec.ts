...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './template-checklist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATECHECKLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATECHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATECHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATECHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATECHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATECHECKLIST actions', async () => {
      const expectedActions = [
        {
